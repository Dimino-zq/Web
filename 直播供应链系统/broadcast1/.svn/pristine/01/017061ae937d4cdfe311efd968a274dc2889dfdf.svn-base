package edu.hfu.broadcast.dao.base;
...
public class BaseDaoImpl implements BaseDao {
	...
	public <T> T get(Class<T> entityClass, Serializable id, LockOptions lockOptions) throws Exception {
...
//		session.clear()，把缓冲区内的全部对象清除，但不包括操作中的对象
	...
	public <T> List<T> findByPage(String hql, int pageNo, int maxResults) throws Exception {
		Object[] params = null;
		return findByPage(hql, params, pageNo, maxResults);
	}

	public <T> List<T> findByPage(String hql, Object param, int pageNo, int maxResults) throws Exception {
		return findByPage(hql, new Object[] { param }, pageNo, maxResults);
	}

	@SuppressWarnings("unchecked")

	public <T> List<T> findByPage(String hql, Object[] params, int pageNo, int maxResults) throws Exception {
	...
	@Override
	public List<Map<String, Object>> findBySQL(String sql, int pageNo, int maxResults) throws Exception {
		return this.findBySQL(sql, null, null, pageNo, maxResults);
	}

	@Override
	public List<Map<String, Object>> findBySQL(String sql, Map<String, Type> colNameANDdataType, int pageNo,
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<Map<String, Object>> findBySQL(String sql, Object[] params, Map<String, Type> colNameANDdataType,
