...
public class SystemDao {
	...
	// 新增
	public void addSysPlatInformation(SysPlatInformation system) throws Exception {
		dao.save(system);
	}
	...
	public List<SysPlatInformation> getPlatInfomationByUserId(Integer userId) throws Exception {
		String hql = "from SysPlatInformation where user.userId=?0";
