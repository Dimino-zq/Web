$(document).ready(function(){
	...
	$("#btn_assignDlg").click(function(){
		...
		var rowUser=$("#tbl_grantControl").datagrid("getSelected");
			console.log(rowUser);
	...
	$("#btn_query").click(function(){
        ...
        $('#tbl_grantControl').datagrid('load',queryParams);
    });
	...
	function company(){
	    ...
	    $("#tbl_grantControl").datagrid({
			...
			{field:"userRole",title:"用户角色",width:100,sortable :true,sorter: function (a, b) { return (a > b ? 1 : -1) },
	...
	$("#btn_upd").click(function(){
		var row = $("#tbl_grantControl").datagrid("getSelected");
		if (row==null){
